...
public class Short2DArraySum {

    private static final int ARRAY_SIZE = 10000;
    private static short[][] doubleArray = new short[ARRAY_SIZE][ARRAY_SIZE];
    ...
    public static void setup() {
        ...
        for (int i = 0; i < ARRAY_SIZE; i++) {
            for (int j = 0; j < ARRAY_SIZE; j++) {
                doubleArray[i][j] = (short) random.nextInt(100);
            }
        }
        EXPECTED_SUM = 0;
        for (int i = 0; i < ARRAY_SIZE; i++) {
